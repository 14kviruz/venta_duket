  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="inicio" class="brand-link">
        <img src="assest/dist/img/logo_DUKE.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">EL DUKET DEL SUR</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="assest/dist/img/logo_DUKE.jpg" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
